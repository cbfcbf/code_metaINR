...
t=np.arange(0,10,0.01)
mean_pace=localreg(t_all, y_all,x0=t, degree=1, kernel=rbf.gaussian, radius=0.1)
t_pace=np.arange(0,10,0.2)
mean_pace_for_t_pace=localreg(t_all, y_all,x0=t_pace, degree=1, kernel=rbf.gaussian, radius=0.1)
mean_pace_all=localreg(t_all, y_all, degree=1, kernel=rbf.gaussian, radius=0.1)
