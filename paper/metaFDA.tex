...
As shown in Figure 1, we found that when providing observations solely for the latter segment ($t \in [5, 10]$) of a particular sample, 
...
As demonstrated in Figure 2, the meta-learning process is accompanied by the meta-model gradually converging towards the mean.
...
\textbf{Estimation of mean, covariance and principal components}
% 如图展示了MetaINR在实际sparse functional dataset中的估计结果。我们发现
