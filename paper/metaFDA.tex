...
\begin{abstract}
  Sparse time series data is formed by sparsely observed samples from a given function distribution. However, traditional statistical methods struggle to analyze such data effectively. 
...
$$
According to the covariance operator, we can further estimate its principal components $\hat{\phi}_k(t)$ and the variance of scores $\hat \lambda_k$ by calculate the eigenfunctions and eigenvalues of $\hat{c}(t,s)$.
